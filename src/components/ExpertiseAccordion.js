  ...
  return (
    <React.Fragment>
      ...
      <Accordion open={open === 1} >
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(1)}>
        Infrastructure/PPP
        </AccordionHeader>
...
services regulatory issues.        </AccordionBody>
      ...
      <Accordion open={open === 2}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(2)}>
...
matters and compliance with international standards
      ...
      <Accordion open={open === 3}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(3)}>
        Banking & Finance
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
helps to achieve the client’s business needs.        </AccordionBody>
      ...
      <Accordion open={open === 4}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(4)}>
        Property
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
property related issues.
      ...
      <Accordion open={open === 5}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(5)}>
...
dealing and market manipulation laws, public policy and regulatory sanctions.        </AccordionBody>
      ...
      <Accordion open={open === 6}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(6)}>
        Capital Markets
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
and new entrants to the stock exchange and in the capital markets.        </AccordionBody>
      ...
      <Accordion open={open === 7}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(7)}>
...
courts in Zimbabwe.        </AccordionBody>
      ...
      <Accordion open={open === 8}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(8)}>
...
experience.        </AccordionBody>
      ...
      <Accordion open={open === 9}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(9)}>
        Employment
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
in labour litigation and alternative dispute resolution, compliance, training and education.        </AccordionBody>
      ...
      <Accordion open={open === 10}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(10)}>
        Tax Planning
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
support and tax dispute resolution.        </AccordionBody>
      ...
      <Accordion open={open === 11}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(11)}>
...
Zimbabwe including banking institutions and companies both listed and private.        </AccordionBody>
      ...
      <Accordion open={open === 12}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(12)}>
...
commercial ,compliance and regulatory advice.        </AccordionBody>
      ...
      <Accordion open={open === 13}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(13)}>
        Environmental Law
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
management and importation and transit of hazardous substances        </AccordionBody>
      ...
      <Accordion open={open === 14}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(14)}>
...
courts in Zimbabwe. Immigration matters are also handled by this specialist division.        </AccordionBody>
      ...
      <Accordion open={open === 15}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(15)}>
        Family Law
        </AccordionHeader>
        <AccordionBody className='text-white'>
...
proud of the contribution we have made in the development on the law in area.        </AccordionBody>
      ...
      <Accordion open={open === 16}>
        <AccordionHeader className='text-white text-left'onClick={() => handleOpen(16)}>
